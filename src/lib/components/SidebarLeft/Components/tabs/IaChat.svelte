...
<div class="">
  ...
  <div
    ...
    class="relative h-[calc(100vh-50px)] overflow-y-auto p-4 space-y-4"
  >
    <div class="flex flex-col space-y-4">
      ...
      {#if isLoading}
        <div class="flex justify-start">
          <div class="bg-[#f4f4f5] p-3 rounded-lg">Escribiendo...</div>
        </div>
      {/if}
    </div>
  </div>

  <div class="flex space-x-2 fixed bottom-5 w-[415px]">
    <input
